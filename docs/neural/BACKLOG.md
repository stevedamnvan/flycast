...
| FC-044 | 4 | D3D11 DLAA/SR | 240-frame public NGX matrix | doing | LOG #34,#37-#40,#61,#63,#72,#94; deterministic Soulcalibur combat now covers target-native Auto/J/K and exact 427x320-to-640x480 Quality SR; Auto beats J on the fidelity components and K provides no material gain, so Auto remains default; 8x/external and broader-title evidence remain pending for Gate 16 |
...
| FC-054 | 5 | Capture CLI | Rate-limited artifact package | doing | LOG #73-#74,#90-#94; bounded production D3D11/D3D11On12 normal/OIT capture writes source/guidance/public/final/difference/flicker artifacts, locale-stable manifests, correspondence diagnostics, component metrics, and a provenance/status-aware comparison index; opt-in test-automation captures retain the exact input stream/hash, and external confirmation remains fail-closed; capture GPU timings and the full title matrix remain |
...
| FC-065 | 6 | Manual game matrix | Legal available images; gaps stated | doing | LOG #73,#90,#94; Soulcalibur now has a pixel-repeatable 30-frame Hoko Temple combat sequence with exact retained input provenance across native, target-native DLAA Auto/J/K, and accepted 427x320 Quality SR; target-native Auto reduced average temporal variance from 31.93 to 9.67 with 29/30 valid-history frames and zero repeats/drops/HUD mismatches; gameplay 8x/external profiles, other legal titles, and a final winner remain |
