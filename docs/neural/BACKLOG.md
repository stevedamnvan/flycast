...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#64,#66-#69; 76 checks pass in both NGX and no-NGX builds, including production motion/disocclusion HLSL on D3D11 and D3D11On12, accepted-history aging/ring exclusion, assignment, bounded reindex, deformation rejection, scene cut, and conflicts; later quality-gate tests remain pending |
