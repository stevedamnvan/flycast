...
| FC-031 | 3 | Draw matching | Three tiers, strips, rigid fit, reactive/N2 | doing | LOG #17,#27,#64; small exact-structure buckets use deterministic minimum-cost one-to-one assignment with pose/depth/order cost and recorded best/second-best costs; large repeated buckets are ambiguous; renderer vertex correspondence pending |
...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#64; 60 checks pass in both NGX and no-NGX builds, including exact depth/motion/color plus structural-pose, content-generation, assignment, and large-ambiguity controls; production numerical HLSL equivalence remains pending |
