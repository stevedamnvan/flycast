...
| FC-033 | 3 | Confidence/mask | R8 confidence and required bias rules | doing | LOG #27,#29,#64,#67; production export now gates motion by match confidence, vertex validity, and 128-pixel magnitude, with zero motion/confidence plus bias one on rejection; full residual/history/scene-cut confidence and disocclusion remain pending |
