...
| FC-044 | 4 | D3D11 DLAA/SR | 240-frame public NGX matrix | doing | LOG #34,#37-#40,#61,#63,#72,#94-#95,#101; deterministic Soulcalibur combat covers target-native Auto/J/K, exact 427x320-to-640x480 Quality SR, and a 5120x3840 8x-native reference; Auto beats J on the fidelity components and K provides no material gain; an exact-input 30-frame external comparison was slightly steadier but materially worse in source fidelity, so public Auto remains the safer faithful baseline and no external winner is declared |
...
| FC-054 | 5 | Capture CLI | Rate-limited artifact package | doing | LOG #73-#74,#90-#95,#99-#101; bounded production D3D11/D3D11On12 normal/OIT capture writes source/guidance/public/final/difference/flicker artifacts, locale-stable manifests, correspondence diagnostics, component metrics, capture-only per-pass GPU timings, and a provenance/status-aware comparison index; restored evidence presentation produced a confirmed 60-frame external sequence, while capture-only policy-OFF retention produced 30 exact-input public-DLAA references without changing native final composition; the full title matrix remains |
...
| FC-064 | 6 | Performance | Invariants and measured targets | doing | LOG #75,#77-#89,#96-#98; asynchronous no-flush production telemetry reports per-pass GPU P50/P95/P99, exact source/accepted/displayed frame identity, present-call intervals, repeat/drop/gap/alternation/latency counters, stage/fallback counts, query-ring pressure, post-warmup VRAM, and scoped Flycast-owned neural GPU-object counts; transition and four 10000-sample normal/OIT soaks cover both surfaces; deterministic 600-frame normal/OIT combat covers public DLAA and the supplied external consumer ON versus explicit policy-OFF with clean cadence, bounded resources, and accepted-frame-filtered D3D12 queue timings; ON/OFF spans remain separate rather than an isolated external-cost claim, and broader-title/actual-device evidence remains |
| FC-065 | 6 | Manual game matrix | Legal available images; gaps stated | doing | LOG #73,#90,#94-#95,#100-#101; Soulcalibur has a pixel-repeatable Hoko Temple combat sequence across native, target-native DLAA Auto/J/K, accepted Quality SR, 8x native, and a 60-frame externally confirmed temporal sequence; 30 external frames were paired to public DLAA by four exact input hashes and animated side by side; external output reduced raw temporal delta by about 4% but worsened PSNR, gradient error, edge recall, color drift, and saturation drift, so it is not the Faithful winner; other legal titles remain unavailable |
