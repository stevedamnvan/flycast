...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#64,#66-#73,#76-#77,#105-#106,#108,#121-#124,#126-#127; 163 checks pass in automation, NGX, and no-NGX builds, including exact production OIT raster-jitter coverage on native D3D11 and D3D11On12 plus the prior profile, history, motion, disocclusion, overlay, provenance, marker, and live-status contracts; all seven developer visualization shaders compile from production source |
