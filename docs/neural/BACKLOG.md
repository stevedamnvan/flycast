...
| FC-055 | 5 | Optional layer classes | Only after FC-044 green | doing | LOG #70; conservative normal/OIT translucency coverage and modifier-volume exclusion close Gate 15A; world/overlay separation and title policy remain Gate 15B |
...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#64,#66-#70; 80 checks pass in both NGX and no-NGX builds, including production motion/disocclusion/OIT reactive HLSL on D3D11 and D3D11On12, accepted-history aging/ring exclusion, assignment, bounded reindex, deformation rejection, scene cut, and conflicts; later quality-gate tests remain pending |
