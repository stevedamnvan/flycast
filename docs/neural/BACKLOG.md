...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#63; 52 checks pass in both NGX and no-NGX builds, including exact depth, motion, production SDR color, alpha, and content-rectangle controls; production numerical HLSL equivalence remains pending |
