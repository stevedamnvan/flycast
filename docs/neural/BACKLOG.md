...
| FC-067 | R | Reuse-first remake feasibility | Bounded scene packet, analytic controls, public Remix SDK adapter disposition, then separately gated moving-game reconstruction | doing | D-096, LOG #154, TRANSFORM-SEMANTICS-AUDIT.md. M1 mock/M2 export, decoder, replay and material sidecar implemented; one source-to-decoded-vertex composite passes projection algebra and wrong/equivalent decomposition controls. Next shared per-context projection/depth calibration across minimum distinct linked samples; no unique-world-origin detour. Strict source equality 29/30 remains failed/parked; framebuffer-light approximation rejected. No world camera, real Remix GPU or combined presentation proven. Does not replace FC-048 or FC-056/066. |
| FC-069 | 6 | Definition of done | All non-contingent requirements green | todo | |

## Next bounded assignment -- FC-067 shared context calibration
