...
| FC-063 | 6 | Failure acceptance | No crash/stall/poison/leak | doing | LOG #35,#75-#76,#78,#80-#87; missing runtime, WARP/non-NVIDIA, and no-NGX return clean unsupported; injected feature-create, evaluate, ring/fence-busy, and device-removed-status controls retain byte-exact native fallback on D3D11 and D3D11On12, bounded holds recover, removed status latches, and active window/context/renderer/surface/game/save-state/pause lifecycle transitions close cleanly on normal/OIT paths; real device loss, SEH, runtime removal while active, focus/alt-tab, and broader transitions remain |
| FC-064 | 6 | Performance | Invariants and measured targets | doing | LOG #75,#77-#87; asynchronous no-flush production telemetry reports per-pass GPU P50/P95/P99, exact source/accepted/displayed frame identity, present-call intervals, repeat/drop/gap/alternation/latency counters, stage/fallback counts, query-ring pressure, and post-warmup VRAM growth; four 600-sample active resize/minimize, borderless-fullscreen, post-context-restart, bidirectional renderer/surface-switch, same-media reload, in-memory save/load, and pause/resume intervals cover normal/OIT D3D11 and D3D11On12; paired 10000-sample normal and OIT soaks are cadence-clean, with normal nonpositive VRAM growth and OIT bounded +647168/native versus flat/On12; title, external, resource-object, and D3D12-queue timing coverage remains |
