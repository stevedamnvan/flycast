...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#64,#66-#71; 93 checks pass in both NGX and no-NGX builds through Gate 15B, including production motion/disocclusion/OIT/overlay HLSL on D3D11 and D3D11On12, accepted-history aging/ring exclusion, assignment, bounded reindex, deformation rejection, scene cut, 2D bypass hysteresis, and conflicts; later quality-gate tests remain pending |
