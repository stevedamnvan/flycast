...
| FC-067 | R | Reuse-first remake feasibility | Bounded scene packet, analytic controls, public Remix SDK adapter disposition, then separately gated moving-game reconstruction | doing | D-093, LOG #151, TRANSFORM-DERIVED-AUDIT.md. M1 mock/M2 export, decoder, replay and source-material sidecar implemented; one transform-to-RAM consumer/arithmetic chain verified. Next bounded derived-generation SQ/DMA/TA lineage or explicit uncorrelated result. Strict source equality 29/30 remains failed/parked; framebuffer-light approximation rejected. No world camera, real Remix GPU or combined presentation proven. Does not replace FC-048 or FC-056/066. |
| FC-069 | 6 | Definition of done | All non-contingent requirements green | todo | |

## Next bounded assignment -- FC-067 derived-generation submission lineage
