...
| FC-064 | 6 | Performance | Invariants and measured targets | doing | LOG #75,#77; asynchronous no-flush production telemetry reports per-pass GPU P50/P95/P99, exact source/accepted/displayed frame identity, present-call intervals, repeat/drop/gap/alternation/latency counters, stage/fallback counts, query-ring pressure, and post-warmup VRAM growth; longer/title/external/D3D12-queue coverage remains |
