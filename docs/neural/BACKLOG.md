...
| FC-063 | 6 | Failure acceptance | No crash/stall/poison/leak | doing | LOG #35,#75; missing runtime, WARP/non-NVIDIA, and explicit no-NGX return clean unsupported status; bounded no-NGX production fallback completed with no query pressure or create/evaluate failure; injected create/evaluate/SEH/busy controls pending |
