...
| FC-031 | 3 | Draw matching | Three tiers, strips, rigid fit, reactive/N2 | doing | LOG #17,#27,#64,#66; small exact-structure buckets use deterministic minimum-cost assignment; exact strip/index correspondence now emits conflict-safe previous positions from accepted history; rigid reindex and Naomi 2 correspondence remain pending |
| FC-032 | 3 | Motion rasterization | RG16F render-pixel current-to-previous | doing | LOG #27,#29,#62,#66; synthetic GPU Gate 12 proves the contract; bounded accepted-frame CPU previous positions now cover exact topology and deformation while reindex/conflicts/N2 remain invalid; DX11 vertex binding and production rasterization remain pending |
| FC-033 | 3 | Confidence/mask | R8 confidence and required bias rules | doing | LOG #27,#29,#64; R8 targets exist, changed content generations and large ambiguous buckets produce zero confidence, and assigned matches record cost separation; full residual/history/scene-cut confidence and HLSL classification remain pending |
...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | doing | LOG #50,#61-#64,#66; 63 checks pass in both NGX and no-NGX builds, including exact accepted-history strip mapping, reindex rejection, and shared-vertex conflict invalidation; production HLSL raster equivalence remains pending |
