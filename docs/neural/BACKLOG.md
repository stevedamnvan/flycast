...
| FC-064 | 6 | Performance | Invariants and measured targets | doing | LOG #75,#77-#88; asynchronous no-flush production telemetry reports per-pass GPU P50/P95/P99, exact source/accepted/displayed frame identity, present-call intervals, repeat/drop/gap/alternation/latency counters, stage/fallback counts, query-ring pressure, post-warmup VRAM, and scoped Flycast-owned neural GPU-object counts; four 600-sample active resize/minimize, borderless-fullscreen, post-context-restart, bidirectional renderer/surface-switch, same-media reload, in-memory save/load, and pause/resume intervals cover normal/OIT D3D11 and D3D11On12; four fresh 10000-sample normal/OIT soaks retained constant 91-object D3D11 and 125-object On12 populations with nonpositive VRAM growth and clean cadence; title, external, and D3D12-queue timing coverage remains |
