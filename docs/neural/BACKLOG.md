...
after a handoff. Registered active in the current task; update documentation
as work progresses without treating a handoff as a stopping point.
...
H items1/2/3/4 complete (LOG807/808/810/811): scopes, depth validation reuse, texture ping-pong and shared owned buffers
