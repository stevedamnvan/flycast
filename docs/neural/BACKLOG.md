...
| FC-030 | 3 | Previous selection | Last successfully evaluated frame | todo | |
| FC-031 | 3 | Draw matching | Three tiers, strips, rigid fit, reactive/N2 | todo | |
...
| FC-034 | 3 | Reset rules | All cadence and scene-cut resets | todo | |
| FC-035 | 3 | Jitter | All VS variants; Halton; unjittered motion | todo | |
...
| FC-060 | 6 | Unit tests | Fifteen specified behaviors pass | todo | |
