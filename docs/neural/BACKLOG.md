...
| FC-055 | 5 | Optional layer classes | Only after FC-044 green | doing | LOG #70-#71,#104; synthetic OIT/composite controls remain green, but real Soulcalibur captures falsified complete HUD coverage and exposed sorted-translucent vertex/index aliasing; actual sorted submissions now drive guidance with reactive-only motion, and protected pixel counts make empty masks explicit; batched/repeated HUD classification and real-title Gate 15A/15B coverage remain open |
